  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/Fintaximages/changeinbusiness/partnership-to-privited-limited-company.png" alt="" />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>Partnership to Private Limited Form</span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>Partnership to Private Limited Form</h2>
      ...
      <h1 className={classes.headingh1}>Partnership to Private Limited</h1>

      <p className={classes.headingp}>
      The most important advantage of registering a private limited company is that it offers a status of a separate legal entity which a partnership corporation does not have. In case of a partnership, a partner’s personal property are connected and they might be held personally liable for each and every debt or liability that the enterprise incurs. Hence, with the growth of enterprise, if partners need to grow its credibility and put limited liability on its members, it is more favorable for the companions to transform their partnership right into a private limited company. Even though statutory compliance for a private limited enterprise are better than the ones of a partnership corporation, it offers the enterprise greater possibilities to flourish and increase its reach.
      </p>
