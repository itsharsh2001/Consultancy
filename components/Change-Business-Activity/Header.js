    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/change-business-activity.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Eligibility to Change Business Activity
          </span>
      ...
      When mainly speaking about the organization, the enterprise goals are described in the essential object clause of MOA. These goals outline the scope of the company’s fundamental business activities inside which it can operate. An organization can not adopt the ones activities, which aren't prescribed in its object clause. With motive of expansion or strategic changes, a organization can also additionally require to adopt new activities or replace business activity in MOA. This change in object clause of MOA is viable after consent of shareholders and the approval from Ministry.
      </p>
