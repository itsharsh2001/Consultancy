...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      This settlement governs the relationship between an organization and an unbiased contractor. It ensures that each the business enterprise and the unbiased contractor are protected.
      </p>
      ...
      <p className={classes.headingp2}>
      An Independent Contractor Agreement is used when you are hiring a contractor. The distinction between an worker and an impartial contractor is, that with an unbiased contractor you solely have say about the last job that is to be done, and now not about methods, timings, materials used etc. It can be signed when you will be completing initiatives for a person/company from time to time, or when you will be receiving offerings from an impartial contractor. In it, you can specify the phrases of the job, the price structure, and estimate the quantity of time the job will take and greater details.
      <br />
It is additionally acknowledged as Independent Contractor Contract, Freelancer Contractor Agreement, and Contract Labor Form.
<br />
It is additionally counseled to have the stated settlement notarized by way of an official notary agent.
