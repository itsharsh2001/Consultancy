...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is No Objection Certificates?
      </h1>

      <p className={classes.headingp2}>
      A No Objection Certificate is required when any individual desires to register a property that isn’t self-owned, as their professional commercial enterprise address. A NOC is supposed to be taken from the proprietor of the property and it have to point out that he is conscious of the present day commercial enterprise on his property and has no objections involving it.
      </p>
      ...
      <p className={classes.headingp2}>
      We furnish a structure for No objection certificates (for tackle proof) assisting you to put together a NOC if your registered commercial enterprise tackle is owned by way of anyone else and now not you. The NOC desires to be signed by way of the proprietor of the property to forestall any disputes in the future. The NOC have to virtually point out the title of the Business and the tackle for which the NOC is issued.
      </p>
