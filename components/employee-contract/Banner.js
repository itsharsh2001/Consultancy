...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      An employment contract is a contract between the business enterprise and the worker defining the phrases and prerequisites of employment.
      </p>
      ...
      <p className={classes.headingp2}>
      We are giving a layout for employment contract which can be used by means of the employer. The contract must encompass all clauses, agreements and phrases which are mentioned for the duration of the employment. It has to ideally be drafted on the letter head of the enterprise and signed through the approved employer.
 
