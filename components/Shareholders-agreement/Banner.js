...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      A shareholder settlement is between the shareholders of a organization in which they figure out the management, structure, directors, shareholding, and manipulate of the company, their rights, and obligations. A shareholders settlement regulates shareholders rights, management, and operation coverage of the company.
      </p>
      ...
      <p className={classes.headingp2}>
      We supply a shareholders settlement structure which can be used to put together a shareholders settlement defining the rights and obligations of the shareholders of the company. Such an settlement has to be organized on the business enterprise letterhead which has to be duly signed by way of the licensed director of the company.
      </p>
