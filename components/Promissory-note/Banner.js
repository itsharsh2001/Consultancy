...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      A promissory note is a document containing a written promise to pay a referred to sum to a special character at a certain date or on demand which has to be duly signed. I typically encompass the precept amount, the activity charge (if any), the parties, date, phrases of reimbursement and maturity date. Sometimes different extra factors are additionally blanketed related to the reimbursement as per the events involved.
      </p>
      ...
      <p className={classes.headingp2}>
      We provide you with promissory notice structure which you can use as a record to promise to pay cash in the future with the prerequisites concerning the identical in the note. Such notice can be organized on a clean piece of paper which has to be duly signed via each the events between whom such promissory be aware has been prepared.
      </p>
