    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/close-a-one-person-company.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
         ...
         Close A One Person Company Form
          </span>
      ...
      If an OPC is inoperative for more than 12 months from the date of incorporation then the proprietor may also observe for closure of the business enterprise under the regular method or Fast Track Exit (FTE) scheme of the MCA. If not so it may be wound up voluntarily or via way of means of the order of the Tribunal. As despite the fact that it’s inoperative it is compulsorily required to file all regulatory compliances and regular returns punctually, unless it has filed the closure files with the concerned ROC. Hence it is higher to file for the closure, so the participants of the business enterprise are relived from fulfilling the legal and regulatory compliances.
      </p>
      ...
      <li>Winding up</li>
      <br />
This form of dissolution is executed through holding a meeting authorized by at the least 2/3 of the creditors taking part in the meeting. In case of winding up a liquidator is to be appointed to control the affairs of the wound up company.
<br />
<br />
<li>Striking off</li> 
<br />
Striking off or elimination of OPC through the Fast track exit scheme When a company gains the fame of a dormant company i.e. it has no activity as a company sine its inception or in the beyond 12 months it will become a Defunct Company which may be wound up with a fast-track procedure which is through STK-2 form.
      </p>
