    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/startingabusiness/private-registration-company.png'
          alt=""
        />
      ...
      We offer speedy and moderate support to register a private limited 
      company through 100% online interaction. Our administrations are 
      trusted by a great many organizations in all significant urban areas of 
      India. Pvt Ltd Company Registration is exceptionally liked by new 
      companies.  The process of registration of company in India is redone by <br/>
      MCA, successful from 26th January 2018. Presently, registration of the 
      company can be finished inside 10-15 work days. Our company utilizes 
      qualified organization secretaries and chartered accountants, who 
      guarantee most elevated consumer <br/> loyalty and opportune conveyance 
      of administration. Entire process is managed online, with regular 
      communication and assistance available throughout. Whole cycle is 
      overseen on the web, with normal correspondence and help accessible 
      all through.
      </p>

      <p className={classes.headingp2}>
      Private Limited Company is one of the mainstream types of business 
      entities in India. A privately owned company is an organization that is 
      owned by non-governmental associations or a generally small number 
      of investors or individuals from an organization. <br /> Normally, a privately 
      owned company doesn't offer or trade its shares to the general public 
      on the stock trades, yet rather the private stock of the company is 
      claimed and exchanged.
      </p>
      ...
      <div className={classes.faq}>
        <FAQ heading="Eligibility to form Private Limited Company" para={eligibility} />
      </div>
    </div>
  );
}
