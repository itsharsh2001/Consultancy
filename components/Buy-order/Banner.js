...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      A buy order (PO) is a business file and first reliable provide issued by way of a client to a seller, indicating types, quantities, and agreed expenses for merchandise or services. It is used to manage the buying of merchandise and offerings from exterior suppliers.
      </p>
      ...
      <p className={classes.headingp2}>
      Buyers draft buy orders. A purchase order has a buy order quantity which is additionally covered in the bill so that suited mapping can be done. A buy order has particular important points of the merchandise needed, requirements, the date it is required through etc.
      </p>
