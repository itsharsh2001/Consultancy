    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/accounting/annual-compliance-for-limited-liability-partnership.png'
          alt=""
        />
      ...
      A Limited Liability Partnership enjoys a separate status. Thus, an company wants to preserve its energetic reputation with the aid of usually submitting with the Ministry of Corporate Affairs (MCA). Annual compliance submitting is obligatory for any LLP, whether or not having a commercial enterprise or not. Annual compliance for LLP requires submitting two separate forms. One of which is for Annual Return, whereas some other one is for Statement of Accounts and Solvency.
      <br />
      The varieties are filed for reporting the things to do and monetary information for every economic yr in the upcoming year. The failure to fulfill LLP Annual Compliance necessities levies an extra rate of ₹ a hundred every day of a prolong until the genuine date of filing. Hence, aside from the mandate, the heavy penalty compels the Designated Partners to fulfill the requirements.
