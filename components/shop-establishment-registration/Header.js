  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/fintaximages/registrationandfilling/shop-and-establishment-registration.png" alt="" />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Shop & Establishment Registration Form
          </span>
      ...
      <h1 className={classes.headingh1}>Shop & Establishment Registration</h1>

      <p className={classes.headingp}>
      Shop and Establishment registration is a state-based registration for each and every commercial enterprise entity to register beneath neighborhood Government. Every entity hooked up with the industrial purpose, such as buying and selling and carrier firms, restaurants, espresso residence or resorts and additionally the area of public entertainment need to attain this registration. Generally, the time restrict supplied for the registration is 30 days from the date of establishment.
      </p>

      <p className={classes.headingp}>
      The foremost reason of such registration is to work as per the State legal guidelines and impervious the advantage for the employees. The license would work as proof of business things to do for many different registrations and is additionally useful for opening a financial institution account.
      </p>
