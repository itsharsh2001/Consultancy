...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      An provide letter is given to a man or woman by means of a company, making a formal job provide to him after the completion of the determination procedures.
      </p>
      ...
      <p className={classes.headingp2}>
      We supply an easy-to-use structure which can be used to draft an Offer Letter via the employer. The letter is commonly drafted on a organization letter head and is signed and approved by way of the employer. The letter consists of records such as the job function being offered, job location, beginning date and different facts pertaining to the job. An provide letter has to be frequent through the candidate by using signing on a replica of that letter and returning the replica to the employer.
      </p>
