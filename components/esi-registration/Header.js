    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/registrationandfilling/esi-registration.png'
          alt=""
        />
      ...
      Employee’s State Insurance (ESI) Scheme runs beneath an unbiased authority- Employee State Insurance Corporation which falls below the jurisdiction of the Ministry of Labor & Employment. This scheme is designed to supply the socio-economic safety to personnel working in a company. Medical benefits, ailment benefit, maternity gain and quite number different advantages to the personnel and their household are blanketed beneath this scheme. The scheme additionally extends the monetary help and clinical care to the personnel alongside with their household member insured beneath ESI Act. The organization and worker want to make contribution to the ESIC and hence, it can be referred to as as self- financing scheme. The enterprise desires to register below ESI Scheme which can be taken on line at www.esic.in (Government portal) as soon as the company falls underneath the responsibility of taking this registration.
      </p>
      ...
      Payment: fifteenth of each month<br/>
      Returns: May eleventh and November 11th<br/>
      </p>
      ...
      <p style={{textAlign:'left'}}  className={classes.headingp2}>
      Payment: fifteenth of each and every month<br/>
      Returns: May twenty fifth of each and every month<br/>
      </p>
