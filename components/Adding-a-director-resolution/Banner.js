...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is Adding a Director Resolution?
      </h1>

      <p className={classes.headingp2}>
      To appoint a director a decision has to be handed in the board conferences of the companies. Such decision can be exceeded with the aid of an easy majority through the administrators of the business enterprise situation to the widest variety of administrators which can be appointed. On the passing of such resolution, the extra director can without delay use rights as a director of the company.
      </p>
      ...
      <p className={classes.headingp2}>
      We supply a Adding a director decision layout which will assist you to bypass the decision in the board assembly to add a director. Such decision has to be drafted on the letter head of the organization in minutes of the assembly duly signed with the aid of the administrators of the company.
      </p>
