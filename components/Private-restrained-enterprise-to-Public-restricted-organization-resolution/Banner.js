...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is Private Restrained Enterprise to Public Restricted Organization Resolution?
      </h1>

      <p className={classes.headingp2}>
      In the tournament of conversion of the personal restrained organization to a Public confined company, such decision has to be exceeded in the board meeting. With the instantaneous impact of such decision duly signed by means of the approved director of the company, such personal restricted enterprise receives transformed into a Public restrained company.
      </p>
      ...
      <p className={classes.headingp2}>
      We supply a Private confined corporation to Public constrained employer decision structure which will help you to bypass the decision in the board assembly when there is a requirement of such conversion. Such decision has to be drafted on the letter head of the corporation duly signed via the approved director of the company.
      </p>
