  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/Fintaximages/changeinbusiness/change-partnership-deed.png" alt="" />
      ...
      <h1 className={classes.headingh1}>Change Partnership Deed</h1>

      <p className={classes.headingp}>
      Partnership Deed is a essential document for the company because it governs the company’s operations and activities. The companions should abide by the clauses of partnership deed for the duration of its existence and should now no longer act beyond the scope drawn. Hence, to increase or restrict the scope of activities or operations, companions might also additionally change the partnership agreement. The adjustments in Partnership deed are made through execution of a supplementary deed that is an addendum to the authentic partnership deed. Payment of suitable stamp duty is a must for said deed. The registration of the supplementary deed might be obligatory if the company is already registered with Registrar of Firm.
      </p>
