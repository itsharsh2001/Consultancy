    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/fintaximages/intellectualproperty/provisional-patent.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
         ...
         Provisional Patent Registration Form
          </span>
      ...
      The Provisional Patent affords a concept about the data reachable in the public area associated to the proposed invention. A Provisional Patent will assist become aware of and examine the comparable or applicable patent or non-patent file to figure out about patentability of the proposed invention.
      </p>

      <p className={classes.headingp2}>
      The patent is an extraordinary criminal proper of the patentee that offers him the felony authority to limit others from making or the use of a patented invention. Provisional software is a quick synopsis disclosing the essence and the nature of the invention. 
      </p>
      <p className={classes.headingp2}>
      It is the preliminary software that can be filed earlier than submitting the whole specification. It explains the patent in short however no longer completely. Filing a provisional patent is very beneficial for inventors as it locks the precedence date and secures the invention so that no one else can declare authority over it.
      </p>

      <div id="headerMobile" className={classes.mobileVersionQuery}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
         Provisional Patent Registration Form Form
          </span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>
           Provisional Patent Registration Form Form
