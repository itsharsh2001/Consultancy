  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/fintaximages/registrationandfilling/ssi-msme-registration.png" alt="" />
      ...
      <h1 className={classes.headingh1}>SSI MSME Registration</h1>

      <p className={classes.headingp}>
      Previously recognised SSI registered entities are now acknowledged and registered as MSME, i.e.; Micro, Small and Medium Enterprises. MSME stands for Micro, Small and Medium enterprises, labeled based totally on the annual income in business. These entities possess MSME registration certificate, registered with MSME Department of the Central Government beneath MSME Development Act, 2006. The Act used to be enacted for the promoting and boom of the corporations working at small or medium scale.
      </p>

      <p className={classes.headingp}>
      Where all foremost things to do have been eligible for registration beneath MSME earlier, buying and selling and different few things to do are now especially excluded from eligibility. Although the registration is voluntary, companies select to achieve MSME registration on line due to severa advantages declared by means of the government.
      </p>
