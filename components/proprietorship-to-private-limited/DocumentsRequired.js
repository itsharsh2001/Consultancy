...
export default function DocumentsRequired() {
    return (
        <div>
            <h2 className={classes.p}>Documents for Proprietorship to Private Limited Conversion</h2>
        <div className={classes.documents}>
            ...
            <Documents image="Fintaximages/Documents/im3.png" text="Director's Address Proof"/>
            <Documents image="Fintaximages/Documents/im4.png" text="Income Tax Returns"/>
