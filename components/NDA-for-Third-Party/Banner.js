...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is NDA for Third Party?
      </h1>

      <p className={classes.headingp2}>
      A non-disclosure settlement (NDA), is a contract between at least two events that outlines personal material, knowledge, or statistics that the events desire to share with one every other for sure functions however desire to hinder get admission to or via 0.33 parties.
      </p>
      ...
      <p className={classes.headingp2}>
      NDA is used when a new enterprise possibility is being negotiated; when a commercial enterprise is outsourcing software program or internet improvement work; when a developer is sub-contracting work to deliver in extra sources or expertise; and when an worker is taken on.
      </p>
