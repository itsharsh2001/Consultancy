    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/change-company-name.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Eligibility to Change Company Name
          </span>
      ...
      A company’s name can be modified at any time after its incorporation. It being an entity regulated by law, it has to comply with a selected manner provided through the Companies Act, 2013. The manner consists of engaging in board assembly and member’s assembly for his or her respective consent, which will be observed through name reservation and approval from Central Government for stated change. Fresh Certificate of Incorporation might be issued through ROC in new name after updating the Register of Companies. The company name change does not affect the existence of the agency, which leaves all of the assets and liabilities unaffected.
      </p>
