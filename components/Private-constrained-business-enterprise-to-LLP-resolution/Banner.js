...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is Private Constrained Business Enterprise to LLP Resolution?
      </h1>

      <p className={classes.headingp2}>
      In the match of conversion of the personal constrained business enterprise to Limited legal responsibility partnership, such decision has to be surpassed in the board meeting. With the instant impact of such decision duly signed via the approved director of the company, such non-public confined employer receives transformed into restricted legal responsibility partnership.
      </p>
      ...
      <p className={classes.headingp2}>
      We grant a Private restricted corporation to LLP decision structure which will assist you to ignore the decision in the board assembly when there is a requirement of such conversion. Such decision has to be drafted on the letter head of the organization duly signed by using the approved director of the company.
      </p>
