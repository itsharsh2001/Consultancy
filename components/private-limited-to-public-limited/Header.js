  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/Fintaximages/changeinbusiness/private-limited-company-to-public-company.png" alt="" />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>Private Limited To Public Limited Form</span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>Private Limited To Public Limited Form</h2>
      ...
      <h1 className={classes.headingh1}>Private Limited To Public Limited</h1>

      <p className={classes.headingp}>
      Private confined companies are a dime a dozen, however each private confined company, at a few point, needs to turn public so as to growth scalability. Conversion of Private Company right into a Public Company opens a brand new door of opportunities, in particular with inside the form of fundraising and attain of the market. The organization can raise funds via Public Issue and receive deposits too. This shape is suitable for the medium and massive scale businesses. The conversion might be accompanied via way of means of the approval from Government and alteration to MOA & AOA. Further, at the very least 7 participants and 3 administrators are required for conversion of Pvt. Ltd to Public Ltd. The rights, liabilities, powers, and responsibilities stay the same for the organization even after the conversion. Transfer of stocks is feasible because the restriction on switch is eliminated on conversion.
      </p>
