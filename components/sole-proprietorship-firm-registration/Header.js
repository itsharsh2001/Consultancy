    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/fintaximages/startingabusiness/sole-prioprietorship-firm.png'
          alt=""
        />
      ...
      A sole proprietorship (also referred to as individual entrepreneurship, sole trader, or simply proprietorship) is a form of an unincorporated entity this is owned by one person only. It is the simplest legal form of a business entity.


      </p>

      <p className={classes.headingp2}>
      Most companies in India begin individually without other’s participation. An individual carrying out enterprise activities is the only owner and its enterprise entity is stated to be a Proprietorship Firm. The identity of an individual and the enterprise are not different from every other. But because of the decrease tax rate, flexibility and a couple of benefits humans prefer this structure for the early stage of enterprise. With the inclusion of partners, the control over operation reduces. Hence, those owners select to run the enterprise single-handedly and land upon sole proprietorship company registration. Although there may be no particular Act to regulate this organization, there are numerous approaches to register a Sole Proprietorship company. Small groups aiming to take lower risks choose this structure.
      </p>

      <div id="headerMobile" className={classes.mobileVersionQuery}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
          Sole Proprietorship Firm Registration Form
          </span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>
            Sole Proprietorship Firm Registration Form
