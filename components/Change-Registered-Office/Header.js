    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/change-registered-office.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Eligibility to Change Registered Office
          </span>
      ...
      The registered workplace is an official address in which a company is incorporated or registered. All the legit communications made to the company are addressed to the registered workplace which is likewise displayed in the master data of the company. In case of any change in address, it should be up to date with MCA, even though the workplace is modified in the same city. Companies Act prescribes a specified manner to be followed to change the address. The procedure of registered workplace change relies upon on where the workplace is shifted to i.e. in the city, in the jurisdiction of ROC or to different State. In all cases, consent from shareholders and the approval from involved ROC is compulsory.
      </p>
