    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/fintaximages/registrationandfilling/TAN-application.png'
          alt=""
        />
      ...
      Tax Account Number is usually referred as Tax Deduction Account Number or Tax Collection Account Number, or definitely TAN. TAN registration leads to a era of 10 digits alpha-numeric code that is issued through the Income Tax Department of India. As the title suggests, it is bought by using the character accountable for deduction or series of tax at supply (TDS or TCS). Businesses whilst deducting the salaries of personnel need to acquire and point out the number. Specified standards to acquire and deduct tax at supply are already prescribed with the aid of the Government. Also, it is obligatory to quote TAN of the assesse in TDS/ TCS statements and challan for price of TDS/ TCS.
      </p>
