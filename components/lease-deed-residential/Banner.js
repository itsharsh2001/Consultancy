...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is Lease Deed-Residential?
      </h1>

      <p className={classes.headingp2}>
      A hire deed is designed for renting or leasing residential property. The condo settlement or hire deed is a prison file which lays out the prescribed phrases and prerequisites beneath which the rented property is leased out that is to be observed between the landlord and the tenant.
      </p>
      ...
      <p className={classes.headingp2}>
      The rent settlement is used in the instances of any dispute or any different troubles by means of the lessor or the lessee. The apartment settlement should be printed on a Non-Judicial Stamp Paper with a price of Rs.100/- or more. The condo settlement is normally signed on charge of a credit score for the condominium property between the lessor and the lessee. Two copies of the report are commonly executed, with every birthday party maintaining one of the unique copies.
      </p>
