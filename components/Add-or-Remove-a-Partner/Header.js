    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/add-remove-partner.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Eligibility to Add or Remove a Partner
          </span>
      ...
      A Limited Liability Partnership is administered by its members. From its control to the operation, the companions direct the LLP toward its dreams and vision. New companions are introduced or existing leave; it does now no longer have an effect on the popularity of the LLP, however truly influences the increase of the commercial enterprise and obligations of different companions. The alternate in partners and their info may be affected only after the approval from the Ministry of Corporate Affairs. To add or dispose of a partner from LLP, the consent of other companions need to be obtained, that is observed by a change in the LLP Agreement and application to MCA to approve the changes. The application to MCA ought to be filed inside 30 days of effective date of the alternate.
      </p>
