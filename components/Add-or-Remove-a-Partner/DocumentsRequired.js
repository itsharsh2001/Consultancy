...
export default function DocumentsRequired() {
    return (
        <div>
            <h2 className={classes.p}>Documents required for Addition or Removal of partner</h2>
        <div className={classes.documents}>
            ...
            <Documents image="Fintaximages/Documents/im4.png" text="LLP Agreement"/>

            <Documents image="Fintaximages/Documents/im5.png" text="Digital Signature Certificate"/>
        </div>
        </div>
    )
}
