    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/change-llp-agreement.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
            Eligibility to Change LLP Agreement
          </span>
      ...
      LLP Agreement is an essential document that governs the LLP and its operations as a whole. The companions must abide by the clauses laid by it and not to act beyond the scope drawn. An LLP Agreement may be modified any time after incorporation with the mutual settlement of the companions. Among numerous reasons, change in activities or capital or rights and duties are top to guide change. To change any of the clauses, a supplementary settlement is carried out as an addendum to the authentic settlement. It can be carried out through payment of required stamp duty. Any change has to be notified to the ROC (LLP) inside 30 days of change or execution of the supplementary deed.
      </p>
