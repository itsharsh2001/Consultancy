  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/fintaximages/intellectualproperty/trademark-opposition.png" alt="" />
        {/* <Image className={classes.mi}
          src='/privatecompanyOpposition.jpg'
          alt="" 
          height={325}
          width={1286}
          /> */}
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>Trademarks Opposition Form</span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>Trademarks Opposition Form</h2>
      ...
      <h1 className={classes.headingh1}>Trademarks Opposition</h1>

      <p className={classes.headingp}>
      Trademark Opposition in India comes at a stage after the registrar has accepted the trademark software on the uniqueness issue and publishes the trademark in the journal for the third-party opposition. Anyone can oppose the posted trademark inside a length of three months which can be prolonged for a month greater (3+1); establishing from the day it used to be first published. If the mark is opposed, an opposition intending is initiated. After which, each the events worried want to come to a conclusion and the choice is taken. The selection whether or not the mark can be registered or deserted would be made. There is no restricting on submitting an opposition. Anyone who believes that the posted mark would possibly create confusion amongst the public can file for the opposition whilst the onus of defending the trademark lies in the palms of trademark registrant.
      </p>
