  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/Fintaximages/registrationandfilling/gst-registration.png" alt="" />
      ...
      <h1 className={classes.headingh1}>GST Registration</h1>

      <p className={classes.headingp}>
      The Goods and Service Tax is the largest oblique tax reform which blends in all the different taxes into one single tax structure. Under GST Regime, the items and offerings are now taxed underneath a single regulation being Goods and Service Tax Laws. The taxes are levied at a single rate. The series is then bifurcated between each Central and State Government in title of CGST and SGST or IGST.
      </p>
      <h1 className={classes.headingh1}>Threshold Limit for Registration</h1>

      <p className={classes.headingp}>
      The registration underneath GST is obligatory for the commercial enterprise entities primarily based on the standards of turnover or activities. The enterprise dealing in items and these imparting carrier have to mandatorily observe for GST Registration if their combination turnover for a economic 12 months exceeds Rs.40 Lakhs and Rs.20 Lakhs respectively. However, for enterprise making elements and presenting offerings in the North Eastern States, the equal is Rs. 20 lakhs and Rs. 10 lakhs respectively. Owing to its benefits, many dealers additionally achieve voluntary registration beneath GST.<br/>
The GST registration in India is absolutely an on-line process. GST Registration affirms seamless waft of Input Tax Credit in addition to imparting awareness as a registered supplier.
