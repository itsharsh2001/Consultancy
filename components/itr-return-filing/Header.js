  ...
  return (
    <div id="header">
      <div className={classes.imgMobile}>
        <img className={classes.mi} src="/Fintaximages/registrationandfilling/itr-filing.png" alt="" />
      ...
      <h1 className={classes.headingh1}>ITR Return Filing</h1>

      <p className={classes.headingp}>
      The earnings earned by using the individuals and businesses are subject to tax. The tax levied on the earnings of a individual is Income tax, which is levied and accumulated by means of the Central Government. Such tax on earnings earned is payable in the identical monetary yr. whereby it is collected in the structure of improve tax. But the intimation and calculation of the earnings as properly the tax legal responsibility is furnished in the Assessment Year. This intimation structure is referred to as Income Tax Return. The structure and time restrict for submitting ITR are extraordinary for one-of-a-kind taxpayers primarily based on the criteria.<br/>
      Income Tax Return varieties are lately modified, to simplify the consumer experience. But via these new or modified schedules, it is obvious that taxpayers are accountable to show a declare of expenses, exemptions and deductions. Hence, on line submitting of earnings tax return requires help from skilled gurus to make certain the right submitting of your return.
      </p>
