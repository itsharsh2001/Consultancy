...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      What Is Direct Selling Agreement?
      </h1>

      <p className={classes.headingp2}>
      A direct promoting settlement is an settlement made between a enterprise and an agent approved to sell/distribute merchandise of that enterprise on its behalf. It describes in written important points the phrases of commission, returns policy, mental property utilization etc. between the commercial enterprise and the agent.
      </p>
      ...
      <p className={classes.headingp2}>
      A DSA can be used with the aid of any enterprise inclined to appoint direct promoting dealers on its behalf. This settlement ought to be printed on a Non-Judicial Stamp Paper with a price of Rs.200/- or more. The Direct Selling Agreement is made in two copies and the agent and the commercial enterprise every hold one unique reproduction of the settlement for their records.
      </p>
