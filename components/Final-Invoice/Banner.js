...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      Final Invoice is the remaining consignment typically dispatched after a challenge or order is completed, which consists of the whole quantity of cash nevertheless owed.
      </p>
      ...
      <p className={classes.headingp2}>
      A Final Invoice is used to exhibit your clients a clear and concise view of what they are buying, how lots quantity is due and when is the quantity due.
      </p>
