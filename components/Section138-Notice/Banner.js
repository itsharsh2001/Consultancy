...
export default function Banner() {
  ...
  return (
    <div className={classes.container}>
      ...
      Section 138 Notice can be used when a cheque has bounced or charge wasn’t received. It allows the beneficiary to ship a word to the cheque company beneath Section 138 of the Negotiable Instruments Act, inside 30 days of cheque return/non-payment. It is a serious and a association order to the cheque company that if the price isn’t processed, the beneficiary will proceed in addition action. Getting filed below part 138 note is a punishable offense.
      </p>
      ...
      <p className={classes.headingp2}>
      The note ought to include a reference to Section 138 of the Negotiable Instruments Act, statistics about when the cheque used to be presented, the cause for non-realization of charge and a request to the cheque company to organize for charge via alternate means. A Section 138 Notice need to be introduced to the cheque provider inside 30 days of return of cheque due to non-payment to be valid. It should additionally point out the quantity payable and the order small print if necessary.
      </p>
