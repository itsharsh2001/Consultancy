    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/close-a-limited-liability-partnership.png'
          alt=""
        />
      ...
      As LLP is a separate legal entity, it is created through following a legal proceeding therefore with regards to its closure there's a proper legal process to be followed. An LLP can be closed via winding-up or via striking off its name from Register of LLP. The winding-up can be an expensive or time-consuming affair for lots LLPs because it consists of approval from Tribunals and involvement of Liquidators. Therefore, the LLP that has been non-operative on account that its formation or for greater than a year, can also additionally continue the easy way of exit i.e. Strike-off. The LLP could be declared struck-off after the publication of notice through Ministry. Once it is struck-off, the LLP cease to be in existence in eyes of law.
      </p>

      <div id="headerMobile" className={classes.mobileVersionQuery}>
        <div className={classes.headerBackground}>
          <span className={classes.formheading}>
          Eligibility to Close A Limited Liability Partnership 
          </span>
          <div className={classes.form}>
            <h2 className={classes.formh2heading}>
            Close A Limited Liability Partnership
