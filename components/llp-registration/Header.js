    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/startingabusiness/limited-liability-partnership.png'
          alt=""
        />
      ...
      We offer speedy and moderate support to register a limited liability company through 100% online interaction. Our experts are trusted by a great many organizations in all significant urban areas of India. The process of LLP Registration in India is redone by the Ministry of Corporate Affairs. A speedier process of LLP incorporation is made accessible on second October 2018 as a component of the simplicity of working together drive by the public authority. Our services are equally important in big cities as well as small towns of the country.
      </p>

      <p className={classes.headingp2}>
      Limited Liability Partnership (LLP) has turned into a favored type of association among businessmen as it fuses the advantages of both partnership firm and company into a solitary type of association. The idea of the Limited Liability Partnership (LLP) was presented in India in 2008. A LLP has the qualities of both the partnership firm and company. The Limited liability Partnership Act, 2008 directs the LLP in India. Least two parties are needed to consolidate a LLP. However, there is no upper limit on the maximum number of partners of an LLP.
      </p>
