    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/changeinbusiness/close-a-private-limited-company.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
         ...
         Close A Private Limited Company Form
          </span>
      ...
      If the company proprietors or administrators determine to stop or wind up the business, they will keep in mind for the options of the closure. Most viable or simplest manner to shut a company is striking off its name from Register of Companies. This is best while a company is inoperative for a certain period. Other alternatives consist of a winding-up petition, but that includes more time, funding and compliance. On approval of the strike off, the company’s name is eliminated from the register and thus, it isn't existent in the eyes of laws. The company should satisfy all of the compliance before intending for the strike-off application. The application is followed through numerous files and calls for assistance from the professional.
      </p>
      ...
      <p className={` ${classes.headingleft}`}>
      <li> Striking off </li><br/>
 When a organization is inoperative for the reason that its inception or in the past years, it can practice for strike-off, often referred as fast-track exit.<br/>
 <br />
  <li>Winding up </li><br/>
 This alternative is favored whilst the corporation is in the operative level and has assets and liabilities. It will consist of approval from Members, Directors, and creditors.<br/>
