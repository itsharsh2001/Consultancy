    ...
    <div id="header">
      <div className={classes.imgMobile}>
        <img
          ...
          src='/Fintaximages/startingabusiness/producer-company.png'
          alt=""
        />
      ...
      <div className={classes.imagePart}>
        <div className={classes.headerBackground}>
          ...
          Producer Company Registration Form
          </span>
      ...
      The economy of India is an agricultural centric economy. Around 60% of the population relies upon agricultural activities for his or her livelihood. But, the primary producers and farmers have had a protracted battle in India.
      </p>

      <p className={classes.headingp2}>
      A producer company is basically an organization registered to address the primary production of its active member associated with farming. The primary goal consists of production to its promoting and exporting also. For the cause of incorporation of producer company, Part IXA of Companies Act, 1956 is relevant till any unique Act is enacted for such companies. A producer company is registered with ten or more member being producers; or any or more producer institutions; or its combination. Alike every other organization, the liability of its members is limited to the extent of unpaid proportion capital by its members. The producer company is deemed to be a private limited company under this Act, however, the edge of the number of members does not apply to same.
      </p>
