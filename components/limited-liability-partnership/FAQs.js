...
export default function FAQs() {
    ...
    return (
        <div className={classes.body}>
            ...
            <FAQ heading="What are the important requirements/elements for registering an LLP? " para="Like all partnerships registration calls for two or more people to be the designated partners, one partner being an Indian national. The registered workplace needs to be in India."/>

            <FAQ heading="Do I have to apply for a fresh registration in the name of LLP or amend the registrations in the name of Proprietorship Firm? " para="The method for conversion of proprietorship into LLP will be filed with the involved department as registrations in the name of Proprietorship Firm cannot be amended. All the registrations are taken in the name of Proprietorship, if now no longer required for every other purpose, will be surrendered."/>

            <FAQ heading="Whether LLP can be registered for Not-for-profit activities?" para="Profit making is an important condition for an LLP; as a result LLPs cannot be integrated for project of non-profit activities."/>
